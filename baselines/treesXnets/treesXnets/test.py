...
if __name__ == '__main__': 
    ...
    #    train_data = binary_train[0]
    #    test_data = binary_test[0]
    #elif task_type == "REG":
    #    dataset_path = "dataset/regression/"
    #    train_data = reg_train[0]
    #    test_data = reg_test[0]

    #data_train = load_svmlight_file(dataset_path + train_data, zero_based=False)
    #data_test = load_svmlight_file(dataset_path + test_data, zero_based=False)

    data_train = pd.read_csv('./train.csv')
    data_test = pd.read_csv('./test.csv')

    #print("Task type selected is: " + task_type)
    #print("Training dataset is: " + train_data)
    #print("Test dataset is: " + test_data)
    ...
    X_train = data_train.drop(['price', 'ID'], axis=1).to_numpy()
